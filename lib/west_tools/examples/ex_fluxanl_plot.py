...
parser = argparse.ArgumentParser(
    description="""Plot flux evolution obtained with w_fluxanl."""
)
parser.add_argument(
    "-s",
    "--state",
...
pyplot.title(
    r"Flux evolution for state {} at $\alpha=${} confidence interval".format(
        args.state, h5file["flux_evol"].attrs["mcbs_alpha"]
    )
)
