...
try:
    ...
    cm_hovmol_r = matplotlib.colors.LinearSegmentedColormap.from_list(
        "hovmol_r", numpy.flipud(cmap_data)
    )
    ...
    cm_pdr_r = matplotlib.colors.LinearSegmentedColormap(
        "pdr_r", matplotlib.cm.revcmap(_pdr_data), 2048
    )
