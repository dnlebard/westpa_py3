...
class AdaptiveVoronoiDriver:
    ...
    def __init__(self, sim_manager, plugin_config):
        ...
        rc.pstatus("-adaptive voronoi mapping --------------\n")
        rc.pstatus("enabled: {}\n".format(self.doAdaptiveVoronoi))
        rc.pstatus("max centers: {}\n".format(self.max_centers))
        rc.pstatus("center adding freq: {}\n".format(self.center_freq))
        rc.pstatus("centers: {}\n".format(self.centers))
        rc.pstatus("----------------------------------------\n")
        rc.pflush()
    ...
    def update_bin_mapper(self):
        ...
        rc.pstatus("westext.adaptvoronoi: Updating bin mapper\n")
        rc.pflush()
    ...
    def update_centers(self, iter_group):
        ...
        rc.pstatus("westext.adaptvoronoi: Updating Voronoi centers\n")
        rc.pflush()
